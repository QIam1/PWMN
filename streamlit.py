...
# Configuration Key
firebaseConfig = {
    'apiKey': "AIzaSyDogir8yToC7-R65UlW3a6Ba_EPVArZx6E",
    'authDomain': "pwmn-21dfd.firebaseapp.com",
    'projectId': "pwmn-21dfd",
    'databaseURL': "https://pwmn-21dfd-default-rtdb.firebaseio.com/",
    'storageBucket': "pwmn-21dfd.appspot.com",
    'messagingSenderId': "100047345980",
    'appId': "1:100047345980:web:dc3cc2ebe84c81c425e639",
    'measurementId': "G-EHYPLTX75N"
}
...
st.sidebar.title("Pray With Me ! app")
...
if choice == 'Sign up':
    ...
    if submit:
        ...
        st.success(' You are now One with many Brothers and Sisters!,Thank You For Praying With Us !')
        st.balloons()
        # Sign in
        user = auth.sign_in_with_email_and_password(email, password)
        db.child(user['localId']).child("Handle").set(handle)
        db.child(user['localId']).child("ID").set(user['localId'])
        st.title('Welcome to Pray With Me!   ' + handle)
...
if choice == 'Login':
    ...
    if login:
        ...
        bio = st.radio('The Way...', ['Home', 'Prayer Team', 'Settings'])
    ...
    # IF THERE IS NO IMAGE
        ...
        # HOME PAGE
            ...
            with col1:
                ...
                post = st.text_input("Let's share my current mood as a post!", max_chars=5000)
    ...
    # Prayer Partner FEED PAGE
            ...
            choice = st.selectbox('My Prayer Partners', res)
